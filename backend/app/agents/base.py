...
def debate_system_prompt(agent: Agent, topic: str) -> str:
    return (
        ...
        "새 아이디어 넣기, 기존 아이디어 확장/결합/구체화, 대안 제시, 질문, 반례 지적.\n"
        "- 목표는 원래 질문에 대한 답을 좁히는 것입니다. 매 발언은 '지금 무엇이 맞고 무엇이 아닌지'를 "
        "조금이라도 더 분명하게 만들어야 합니다. 갈래만 새로 벌리고 끝내지 마세요.\n"
        "- 앞사람과 결론이 같다면 같은 말을 반복하지 말고, 근거나 조건을 보태 그 결론을 더 단단하게 만드세요.\n"
        "- 반박은 적당히. 모든 발언에 반박하지 말고 결론이 흔들리는 지점에만 집중하세요. 틀렸다고만 말하고 "
        "끝내지 말고 더 나은 기준이나 대안을 함께 내고, 맞는 부분은 짧게 인정하고 넘어가세요.\n"
        ...
        "비꼬는 질문은 결론이 흔들리는 결정적인 지점에서만 가끔 던지세요. 매 발언마다 따지고 들면 결론에 못 갑니다.\n"
